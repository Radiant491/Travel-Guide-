...
console.log(select4);
  ...
  useEffect(() => {
    Axios.get("http://localhost:7003/api/tour/view",{headers:{"Token":user}})
      .then((res) => {
  ...
  return (
    <>
      ...
      <div className="medal-table" style={{marginLeft:"20%"}}>
        <h2 className="heading-secondary">Places Details</h2>
      ...
      >
        ...
        <DialogContent>
          <img
            src={`http://localhost:7003/uploads/travel/${selectedDetail?.image?.[0]}`}
            className="country-logo"
            style={{
              marginLeft: "2px",
              width: "90%",
      ...
      <Dialog open={close3} onClose={handleClose3} style={{backgroundColor:''}}>
        <DialogTitle>Delete Item</DialogTitle>
        <DialogContent>
       <Edit handleClose4={handleClose4} select4={select4} setSelect4={setSelect4}/>
        </DialogContent>
        {/* <DialogActions>
